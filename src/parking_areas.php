...
<body>
	...
	<div class="shape" >
		...
		<div class="lft_top" onclick="openModal()"><b>Area1</b>
		</div>
        <div class="lft_btm" onclick="openModal()"><b>Area2</b>
		</div> 
		<div class="rt_btm" onclick="openModal()"><b>Area3</b>		
		</div>
		<div class="rt_top" onclick="openModal()"><b>Area4</b>			
		</div>	
	</div></div>
				...
				<div class="row">
					<div class="booking-form">
						<form>
							...
							<div class="form-btn">
								<button class="submit-btn">Select Slot</button>
							</div></div></div>
						</form>
					</div>
				</div>
